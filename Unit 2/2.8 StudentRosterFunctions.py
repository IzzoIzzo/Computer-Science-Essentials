...
def printList():
    print("Students signed up for senior trip.")
...
while True:
    ...
    if choice == "2":
        check = input("What name would you like to check?")
        if check in students_signed_up_for_senior_trip:
            print("They have signed up.")
        else:
            print("They have not signed up.")
    
    if choice == "3":
        amount = len(students_signed_up_for_senior_trip)
        print("The amount of students on the list are", amount)
